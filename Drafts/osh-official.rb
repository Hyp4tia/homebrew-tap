...
# Draft for submission to homebrew/homebrew-cask. The differences from Casks/osh.rb
# are deliberate: the official repository does not allow `auto_updates`, formula
# dependencies, or install steps.
cask "osh" do
  version "1.0.10"
